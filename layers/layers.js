...
lyr__1.set('fieldLabels', {'عرض_ا': 'no label', });
lyr__2.set('fieldLabels', {'OBJECTID': 'no label', 'RefName': 'no label', 'AREA': 'no label', 'رقم_ن': 'no label', });
lyr__3.set('fieldLabels', {'id': 'no label', });
lyr__4.set('fieldLabels', {'Id': 'no label', 'تنظيم': 'no label', });
lyr_POINTS_5.set('fieldLabels', {'X_COORDINA': 'no label', 'Y_COORDINA': 'no label', 'icon_url': 'no label', });
lyr__6.set('fieldLabels', {'مؤقت': 'no label', 'المسا': 'no label', 'مباع': 'no label', 'المال': 'no label', 'التنظ': 'no label', });
